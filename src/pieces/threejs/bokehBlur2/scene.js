...
import { BokehPass2 } from './pass.js'
import { ShaderPass } from '@/lib/postprocessing/ShaderPass'
import { Power } from './shader/power'
...
export default class MainScene {
  ...
  addComposer() {
    ...
    // const powerPass = new ShaderPass(Power)
    // this.composer.addPass(powerPass)

    this.bokehPass = new BokehPass2(this.scene, this.camera, {
      focus: 1.0,
